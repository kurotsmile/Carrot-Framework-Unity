...
namespace Carrot
{
    public enum Window_Input_Type {send_and_act_done,act_done}
    ...
    public class Carrot_Window_Input : MonoBehaviour
    {
        ...
        private WWWForm frm_temp;
        private UnityAction<string> act_done;
        private Carrot carrot;
        private Window_Input_Type type=Window_Input_Type.send_and_act_done;
        ...
        public void set_type(Window_Input_Type t)
        {
            this.type = t;
        }
        ...
        public void set_frm(WWWForm frm)
        {
            this.frm_temp = frm;
        }
        ...
        public void inp_done_act()
        {
            ...
            if (this.type == Window_Input_Type.send_and_act_done)
            {
                if (s_val != "")
                {
                    this.frm_temp.AddField("search", s_val);
                    this.carrot.send(this.frm_temp, this.act_done);
                }
            }else if (this.type == Window_Input_Type.act_done)
            {
                if (s_val != "") this.act_done(s_val);
            }
        }
