...
namespace Carrot
{
    public class Carrot_game : MonoBehaviour
    {
        ...
        {
            WWWForm frm = this.carrot.frm_act("list_music_game");
            this.carrot.send(frm, act_show_list_music_game);
        ...
        public void Show_List_Top_player()
        {
            ...
            this.carrot.send(frm_rank,this.act_success_list_top_player, act_fail_list_top_player);
        }
