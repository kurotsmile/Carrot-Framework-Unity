...
namespace Carrot
{
    public class Carrot_ads : MonoBehaviour
    {
        ...
        //Ads Vungle config
        private bool is_ads_vungle = false;
        ...
        public void load(Carrot carrot)
        {
            ...
            if (this.carrot.type_ads == TypeAds.Vungle_Ads) this.setup_ads_vungle();
        }
        ...
        public void show_carrot_ads()
        {
            ...
            WWWForm frm_ads = this.carrot.frm_act("load_ads");
            this.carrot.send(frm_ads, act_show_ads);
        }

        private void act_show_ads(string s_data)
        {
        ...
        public void setup_ads_vungle()
        {
            Vungle.init(this.carrot.ads_vungle_game_id_window);
            Vungle.loadAd(this.carrot.ads_vungle_interstitial_placement_id);
            Vungle.loadAd(this.carrot.ads_vungle_rewarded_placement_id);
            Vungle.onInitializeEvent += () => { 
                this.is_ads_vungle = true;
                if (this.GetComponent<Carrot>().model_app == ModelApp.Develope) Debug.Log("Initialization Vungle Ads Complete! (Game id:"+this.carrot.ads_vungle_game_id_window + ")");
            };
            Vungle.onAdRewardedEvent += (placementID) => {this.onRewardedSuccess.Invoke();};
        }
        ...
        public void show_ads_Interstitial()
        {
            if (this.is_ads)
            {
                ...
                if (this.count_show_ads >= this.carrot.click_show_ads)
                {
                    ...
                    else if (this.is_ads_vungle)
                    {
                        if (Vungle.isAdvertAvailable(this.carrot.ads_vungle_interstitial_placement_id))
                            Vungle.playAd(this.carrot.ads_vungle_interstitial_placement_id);
                        else
                            this.show_carrot_ads();
                    }
                    else
        ...
        public void show_ads_Rewarded()
        {
            ...
            if (this.is_ads_vungle) Vungle.playAd(this.carrot.ads_vungle_rewarded_placement_id);
        }
        ...
        public void set_enabled_sound_vungle(bool v)
        {
            Vungle.setSoundEnabled(v);
        }
